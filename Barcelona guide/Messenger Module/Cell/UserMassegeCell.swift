...
class UserMassegeCell: UITableViewCell {
    ...
    func configur() {
        ...
        addSubview(fonView)
        fonView.anchor(top: topAnchor , leading: safeAreaLayoutGuide.leadingAnchor, bottom: bottomAnchor, trailing: safeAreaLayoutGuide.trailingAnchor ,pading: .init(top: 20, left: 140, bottom: 20, right: 10), size: .init(width: 0, height: 0))
